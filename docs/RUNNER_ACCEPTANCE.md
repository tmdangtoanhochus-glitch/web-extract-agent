...
Ngày đối chiếu: 2026-09-17, phase 24. **513 test offline pass**, một cảnh báo deprecation
...
Phase 23 đã chốt tài liệu; phase 24 đang kiểm chứng, phase 25 chưa nghiệm thu.
Kết quả môi trường thật ghi tại [RUNNER_UAT_RESULTS.md](RUNNER_UAT_RESULTS.md).
513 test ở trên là regression offline, không thay thế kết quả container/UAT.
...
- AI/MCP tự điều hướng toàn website; raw DOM/accessibility text gửi cho AI.
- Recorder cho iframe/shadow DOM, upload, điều hướng và assertion tự động;
  checkbox/radio hoặc dropdown tùy biến vẫn cấu hình thủ công.
...
hợp AI hiện có, không phải autonomous self-healing.
